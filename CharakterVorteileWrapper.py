...
class CharakterVorteileWrapper(QtCore.QObject):
    ...
    def initVorteile(self):
        ...
        vortList = [[] for _ in VorteilTypen]
        ...
        for i in range(len(vortList)):
            ...
            for el in vortList[i]:
                ...
                if Wolke.DB.vorteile[el].variableKosten:
                    ...
                    elif el in Wolke.Char.vorteileVariable:
    ...
    def load(self):
        ...
        for i in range(len(vortList)):
            ...
            for j in range(itm.childCount()):
                ...
                ) and txt not in Wolke.Char.vorteileVariable:
    ...
    def setVariableKosten(self, name, kosten, kommentar):
        if name not in Wolke.Char.vorteileVariable:
            vk = VariableKosten()
    ...
    def spinnerChanged(self, name, state):
        self._update_spinner_or_kommentar_changed(name, state, None)

    def kommentarChanged(self, name, text):
        self._update_spinner_or_kommentar_changed(name, None, text)

    # TODO Rename this here and in `spinnerChanged` and `kommentarChanged`
    def _update_spinner_or_kommentar_changed(self, name, kosten, kommentar):
        self.setVariableKosten(name, kosten, kommentar)
