...
class Char:
    ...
    def __init__(self):
        ...
        # Versionierung
        # Wenn die Ref-DB eine Änderung erhält durch die
        # existierende Charakter-XMLs aktualisiert werden müssen,
        # kann hier die Datenbank Code Version inkrementiert werden
        # und in der Migrationen-Map eine Migrationsfunktion
        # für die neue Version angelegt werden.
        # In dieser Funktion kann dann die Charakter-XML-Datei
        # angepasst werden, bevor sie geladen wird.
        # WICHTIG: Bei Vorteilen/(ÜB-)Fertigkeiten/Talenten nur solche
        # migrieren, bei denen in der aktuell geladenen Datenbasis
        # userAdded == False ist, außer das schema hat sich geändert.
        # Die Migrationsfunktion sollte einen string zurückgeben,
        # der erklärt was geändert wurde
        # - dies wird dem Nutzer in einer Messagebox angezeigt.
        # Die Funktionen werden inkrementell ausgeführt,
        # bspw. bei Charakter-DB-Version '0' und Code-DB-Version '2'
        # wird zuerst die Funktion für 1, dann die Funktion für 2 aufgerufen
