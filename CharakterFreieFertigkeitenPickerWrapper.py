...
class CharakterFreieFertigkeitenPickerWrapper(object):
    def __init__(self, fertigkeit=None):
        ...
        if fertigkeit is not None:
            if ": " in fertigkeit and fertigkeit not in Wolke.DB.freieFertigkeiten:
        ...
        for kategorie in kategorien:
            ...
            for fert in Wolke.DB.freieFertigkeiten:
                ...
                if (
                    ...
                    and self.ui.nameFilterEdit.text().lower() not in fert.lower()
                    and self.ui.nameFilterEdit.text().lower() not in kategorie.lower()
                ):
                    continue
    ...
    def findKategorien(self):
        kategorien = {
            Wolke.DB.freieFertigkeiten[tal].kategorie: True
